...
$Root = "$env:LOCALAPPDATA\Wetterkurve"
...
Get-AppxPackage -ErrorAction SilentlyContinue | Where-Object { $_.Name -eq 'Wetterkurve.Widget' -or $_.Name -like '*.Wetterkurve' } | ForEach-Object {
